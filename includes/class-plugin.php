...
class PluginUserAccess
{
    ...
    {
        if (defined('PLUGIN_USER_ACCESS_VERSION')) {
            $this->version = PLUGIN_USER_ACCESS_VERSION;
        } else {
            $this->version = '1.0.0';
        }
        $this->plugin_name = 'user-access';
    ...
    private function load_dependencies()
    {
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'public/class-user-access-log.php';
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('admin_menu', $plugin_admin, 'get_top_menu');
    ...
    private function define_public_hooks()
    {
        ...
        $plugin_user_access_log = new User_Access_Log($this->domain_api);
